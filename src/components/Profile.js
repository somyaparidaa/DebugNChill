...
import { User, Award, Clock, Recycle, Camera, Smartphone, DollarSign, FileText, Tag, Save, X } from "lucide-react";
        ...
        <div className="profile-container">
                    ...
                    {!previewMode ? (
                        <div className="sell-container">
                            <div className="section-header">
                                <h2><Tag size={20} /> Sell Your Device</h2>
                                <p>Complete the form below to list your device on the marketplace</p>
                            </div>
                            
                            <form onSubmit={handleSubmit}>
                                <div className="form-group">
                                    <label className="lbl" htmlFor="name"><Smartphone size={16} /> Device Name</label>
                                    <input 
                                        type="text" 
                                        id="name"
                                        name="name" 
                                ...
                                <div className="form-group">
                                    <label htmlFor="brand"><Award size={16} /> Brand</label>
                                    <input 
                                        type="text" 
                                        id="brand"
                                        name="brand" 
                                ...
                                <div className="form-row">
                                    <div className="form-group">
                                        <label htmlFor="condition"><Clock size={16} /> Condition</label>
                                        <select 
                                            id="condition"
                                            name="condition" 
                                            value={device.condition} 
                                            onChange={handleChange}
                                            className={`condition-select ${getConditionClass(device.condition)}`}
                                        >
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="price"><DollarSign size={16} /> Price</label>
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea 
                                        ...
                                        onChange={handleChange}
                                    ></textarea>
                                    <div className="char-count">{device.description.length}/500</div>
                                </div>
                                
                                <div className="form-group">
                                    <label htmlFor="image"><Camera size={16} /> Image URL</label>
                                    <input 
                                        type="text" 
                                        id="image"
                                        name="image" 
                            ...
                            <div className="device-card preview">
                                ...
                                <div className="device-content">
                                    <div className="device-header">
                                        ...
                                        <div className="device-price">${parseFloat(device.price || 0).toFixed(2)}</div>
                                    </div>
                                    <div className="device-brand">{device.brand || "Brand"}</div>
                                    <div className={`device-condition ${getConditionClass(device.condition)}`}>
                                    ...
                                    <div className="device-footer">
                                        <div className="seller-info">
                                            <User size={16} />
                                            <span>{currentUser?.displayName || currentUser?.email?.split('@')[0] || "You"}</span>
                                        </div>
            ...
            {activeTab === "listings" && (
                <div className="listings-container">
                    <div className="section-header">
                        <h2><Smartphone size={20} /> My Device Listings</h2>
                    ...
                    {isLoading ? (
                        ...
                        <div className="listings-grid">
                            {myListings.map(listing => (
                                <div className="device-card" key={listing.id}>
                                    <div className="device-image">
                                        <img src={listing.image || "https://via.placeholder.com/300"} alt={listing.name} />
                                    </div>
                                    <div className="device-content">
                                        <div className="device-header">
                                            <h3>{listing.name}</h3>
                                            <div className="device-price">${parseFloat(listing.price).toFixed(2)}</div>
                                        </div>
                                        <div className="device-brand">{listing.brand}</div>
                                        <div className={`device-condition ${getConditionClass(listing.condition)}`}>
                                        ...
                                        <div className="device-footer">
                                            <div className="listing-date">
                                                Listed {listing.createdAt?.toDate ? listing.createdAt.toDate().toLocaleDateString() : new Date().toLocaleDateString()}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="empty-state">
                            ...
                            <button className="tab-button" onClick={() => setActiveTab("sell")}>
